...
public class KeyValueList<KeyType, ValueType> implements Iterable<Pair<KeyType, ValueType>> {
     ...
     */
    public ValueType addOrAssign(KeyType key, ValueType value, Pair<KeyType, ValueType> pair) {
        ListNode<Pair<KeyType, ValueType>> foundNode = findListNode(key);
        if (foundNode != null) {
        ...
        ListNode<Pair<KeyType, ValueType>> newNode = new ListNode<>();
    ...
    public ValueType remove(KeyType key) {
        ListNode<Pair<KeyType, ValueType>> foundNode = findListNode(key);
        if (foundNode != null) {
            return foundNode.previous().eraseAfter().destruct();
